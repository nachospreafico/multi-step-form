...
const FormStep2 = ({ monthly, setMonthly, setPlan, planId }) => {
  ...
  return (
    <div id="step-2">
      ...
      <div
        className={`billing-option-container ${planId === 1 ? "selected" : ""}`}
        onClick={() => {
      ...
      <div
        className={`billing-option-container ${planId === 2 ? "selected" : ""}`}
        onClick={() => {
      ...
      <div
        className={`billing-option-container ${planId === 3 ? "selected" : ""}`}
        onClick={() => {
      ...
      <div className="billing-slider">
        ...
        <div className="slider-container">
          <div
            className={`slider-${monthly ? "left" : "right"}`}
            onClick={handleBillingOption}
          ></div>
        </div>
